...
public final class CollectionUtils {
     ...
     * <p>示例用法：
     * <pre>{@code
     * Map<String, Integer> emptyMap = MapFactory.emptyMap();
     * Map<String, Integer> singleMap = MapFactory.mapOf("one", 1);
     * Map<String, Integer> multiMap = MapFactory.mapOf("one", 1, "two", 2, "three", 3);
     * }</pre>
     */
