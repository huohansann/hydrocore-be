...
import com.siact.hydrocore.common.constant.ConstantUtil;
...
import com.siact.hydrocore.common.utils.TimeUtil;
import com.siact.ins.server.common.vo.prop.PropJHValVo;
import com.siact.hydrocore.sec.dto.CommonChartDataDto;
...
import com.siact.hydrocore.sec.dto.PropInsDTO;
...
import com.siact.hydrocore.sec.utils.ConvertUtils;
...
public class DataServiceImpl implements DataService {
    ...
    @Value("${sample.chart.enabled:false}")
    ...
    public CommonChartResultDto queryCommonChartData(CommonChartParamsVo vo) {
        if (testModeEnabled) {
            ...
            try {
                ClassPathResource resource = new ClassPathResource("testJson/common/queryCommonChartData.json");
